...
export default async function handler(req, res) {
  ...
  try {
    ...
    const predictionIds = await Promise.all(
      brand.ads.map(ad => startNanaBanana(ad.image_prompt))
    );
